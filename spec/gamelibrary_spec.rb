...
#this first test will extract the title of games users have added, the second will not. The third test, tests whether a hash has been pushed into the instance variable.
