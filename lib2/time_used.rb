class TimeUsed
  ...
  #gets the information from users on their playing habits, to be used in methods below this one
  def user_input
  ...
  #this lengthy method lists the various skills people could have acquired, had they not played games. centered around the @yearly_playtime IV. 
  def skills 
    case @yearly_playtime 
    when 1..30
      puts "Did you know you could have learned to drive manual?"
    when 31..100
      skill = 100 - @yearly_playtime
      remaining_time = skill.abs
      puts "Did you know it takes around 100 hours to become competent, versus any beginner, in a skill?"
      puts "So in another #{skill} hours, you'd have been competent!"
    when 101..500
      ...
      if @yearly_playtime < 400
        ...
        puts "Did you know it would take you around 400 hours to learn French? So you could have already learned French had you been practicing! You have missed approximately #{extra_time} hours of ordering in French!"
      end 
    when 501..1500
  ...
  #calculates the actual average yearly time in this method.
  def time_wasted
    user_input
